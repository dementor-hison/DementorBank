...
public class Defines
{
    ...
    public static enum RegistState
    {
        ...
        public RegistState nextState()
        {
            for (RegistState step : RegistState.values())
            {
                if (this.getValue() < step.getValue())
                {
                    return step;
                }
            }
